 ...
 * WardrobeSvg2D
 * ---------------------------------------------------------
 * 2D elevation renderer for Wardrobe step.
 *
 * - Reads wardrobe.widthFt / baseH / loftH / finish from store.
 * - Builds a row of modules (bays) with doors + loft.
 * - Wraps everything in PanZoomViewport for pan/zoom behavior.
 *
 * NOTE: All distances here are treated as mm for labelling, but
 *       PanZoomViewport only cares about relative scale.
 */

export default function WardrobeSvg2D(): React.ReactElement {
    ...
    >
      {(transform) => (
        <svg
          ...
          className="absolute inset-0 h-full w-full rounded-xl bg-[var(--surface-card)] dark:bg-[var(--surface-card-dark)]"
        >
          {/* defs */}
          <defs>
            <linearGradient id="wallGrad" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop
                offset="100%"
                stopColor="var(--edith-on-primary)"
                stopOpacity="0.22"
              />
            </linearGradient>
