 ...
 * ✅ Reads from useOfflineLedger() store
 * ✅ Integrates into Drawer + Dock
 * ============================================================
 */
...
function StatCard({ label, value, icon: Icon, color }: any) {
  ...
  return (
    <div
      className={clsx(
        "p-3 rounded-xl border border-[var(--edith-border)] bg-[var(--edith-surface-hover)] flex flex-col items-start justify-center",
